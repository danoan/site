...
function create_control() {
  let words_found_cookie_id = '2021-06-22T15:21:07.002543_words_found_monday';
  let iso_expiration_date = '2022-06-17T15:21:07.002543';
...
window.onload = function () {
  ...
  control.ephemeral.add_remaining_word('paper');
  
  control.ephemeral.add_remaining_word('rape');
  
  control.ephemeral.add_remaining_word('prepare');
  ...
  control.ephemeral.add_remaining_word('plan');
  
  control.ephemeral.add_remaining_word('appear');
  
  control.ephemeral.add_remaining_word('arena');
  
  control.ephemeral.add_remaining_word('earn');
  
  control.ephemeral.add_remaining_word('near');
  
  control.ephemeral.add_remaining_word('peer');
  
  control.ephemeral.add_remaining_word('pepper');
  
  control.ephemeral.add_remaining_word('pale');
  
  control.ephemeral.add_remaining_word('learn');
  
  control.ephemeral.add_remaining_word('call');
  
  control.ephemeral.add_remaining_word('panel');
  
  control.ephemeral.add_remaining_word('lane');
  
  control.ephemeral.add_remaining_word('real');
  
  control.ephemeral.add_remaining_word('apple');
  
  control.ephemeral.add_remaining_word('clean');
  
  control.ephemeral.add_remaining_word('place');
  
  control.ephemeral.add_remaining_word('leap');
  
  control.ephemeral.add_remaining_word('parallel');
  
  control.ephemeral.add_remaining_word('creep');
  
  control.ephemeral.add_remaining_word('pace');
  
  control.ephemeral.add_remaining_word('lean');
  
  control.ephemeral.add_remaining_word('replace');
  
  control.ephemeral.add_remaining_word('appeal');
  
  control.ephemeral.add_remaining_word('plea');
  
  control.ephemeral.add_remaining_word('canal');
  
  control.ephemeral.add_remaining_word('cell');
  
  control.ephemeral.add_remaining_word('plane');
  
  control.ephemeral.add_remaining_word('race');
  
  control.ephemeral.add_remaining_word('care');
  
  control.ephemeral.add_remaining_word('clear');
  
  control.ephemeral.add_remaining_word('recall');
  
  control.ephemeral.add_remaining_word('acre');
  
  control.ephemeral.add_remaining_word('career');
  
  control.ephemeral.add_remaining_word('appearance');
  
  control.ephemeral.add_remaining_word('cancer');
  
  control.ephemeral.add_remaining_word('peace');
