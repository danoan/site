...
function create_control() {
  let words_found_cookie_id = '2021-06-16T13:36:17.484209_words_found_monday';
  let iso_expiration_date = '2022-06-11T13:36:17.484209';
...
window.onload = function () {   
  ...
  control.ephemeral.add_remaining_word('inner');
  
  control.ephemeral.add_remaining_word('green');
  
  control.ephemeral.add_remaining_word('reign');
  
  control.ephemeral.add_remaining_word('engineering');
  
  control.ephemeral.add_remaining_word('engine');
  
  control.ephemeral.add_remaining_word('dinner');
  
  control.ephemeral.add_remaining_word('grin');
  
  control.ephemeral.add_remaining_word('deed');
  
  control.ephemeral.add_remaining_word('edge');
  
  control.ephemeral.add_remaining_word('degree');
  
  control.ephemeral.add_remaining_word('deer');
  
  control.ephemeral.add_remaining_word('dining');
  
  control.ephemeral.add_remaining_word('engineer');
  
  control.ephemeral.add_remaining_word('indeed');
  
  control.ephemeral.add_remaining_word('ride');
  
  control.ephemeral.add_remaining_word('ring');
  
  control.ephemeral.add_remaining_word('need');
  
  control.ephemeral.add_remaining_word('grind');
  
  control.ephemeral.add_remaining_word('grid');
  
  control.ephemeral.add_remaining_word('nine');
  
  control.ephemeral.add_remaining_word('gender');
  
  control.ephemeral.add_remaining_word('gene');
  
  control.ephemeral.add_remaining_word('linger');
  
  control.ephemeral.add_remaining_word('render');
  
  control.ephemeral.add_remaining_word('line');
  
  control.ephemeral.add_remaining_word('legend');
  
  control.ephemeral.add_remaining_word('girl');
