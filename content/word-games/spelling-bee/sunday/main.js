...
function create_control() {
  let words_found_cookie_id = '2021-06-22T15:21:06.902049_words_found_sunday';
  let iso_expiration_date = '2022-06-17T15:21:06.902049';
...
window.onload = function () {
  ...
  control.ephemeral.add_remaining_word('intent');
  
  control.ephemeral.add_remaining_word('tent');
  
  control.ephemeral.add_remaining_word('teen');
  
  control.ephemeral.add_remaining_word('tale');
  
  control.ephemeral.add_remaining_word('title');
  
  control.ephemeral.add_remaining_word('elite');
  
  control.ephemeral.add_remaining_word('tone');
  
  control.ephemeral.add_remaining_word('nation');
  
  control.ephemeral.add_remaining_word('entitle');
  
  control.ephemeral.add_remaining_word('tail');
  
  control.ephemeral.add_remaining_word('onto');
  
  control.ephemeral.add_remaining_word('alone');
  
  control.ephemeral.add_remaining_word('online');
  
  control.ephemeral.add_remaining_word('national');
  
  control.ephemeral.add_remaining_word('note');
  
  control.ephemeral.add_remaining_word('little');
  
  control.ephemeral.add_remaining_word('talent');
  
  control.ephemeral.add_remaining_word('attain');
  
  control.ephemeral.add_remaining_word('lane');
  
  control.ephemeral.add_remaining_word('line');
  
  control.ephemeral.add_remaining_word('total');
  
  control.ephemeral.add_remaining_word('lean');
  
  control.ephemeral.add_remaining_word('attention');
  
  control.ephemeral.add_remaining_word('none');
  
  control.ephemeral.add_remaining_word('initiate');
  
  control.ephemeral.add_remaining_word('late');
  
  control.ephemeral.add_remaining_word('tonne');
  
  control.ephemeral.add_remaining_word('onion');
  
  control.ephemeral.add_remaining_word('initial');
  
  control.ephemeral.add_remaining_word('tell');
  
  control.ephemeral.add_remaining_word('nine');
  
  control.ephemeral.add_remaining_word('into');
  
  control.ephemeral.add_remaining_word('intention');
  
  control.ephemeral.add_remaining_word('tenant');
  
  control.ephemeral.add_remaining_word('notion');
  
  control.ephemeral.add_remaining_word('alien');
  
  control.ephemeral.add_remaining_word('noon');
  
  control.ephemeral.add_remaining_word('tall');
  
  control.ephemeral.add_remaining_word('loan');
