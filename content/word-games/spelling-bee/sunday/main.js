...
function create_control() {
  let words_found_cookie_id = '2021-06-16T13:36:17.385015_words_found_sunday';
  let iso_expiration_date = '2022-06-11T13:36:17.385015';
...
window.onload = function () {   
  ...
  control.ephemeral.add_remaining_word('horn');
  
  control.ephemeral.add_remaining_word('honor');
  
  control.ephemeral.add_remaining_word('horror');
  
  control.ephemeral.add_remaining_word('shop');
  
  control.ephemeral.add_remaining_word('ship');
  
  control.ephemeral.add_remaining_word('noon');
  
  control.ephemeral.add_remaining_word('soon');
  
  control.ephemeral.add_remaining_word('spin');
  
  control.ephemeral.add_remaining_word('onion');
  
  control.ephemeral.add_remaining_word('opinion');
  
  control.ephemeral.add_remaining_word('sponsorship');
  
  control.ephemeral.add_remaining_word('poor');
  
  control.ephemeral.add_remaining_word('iron');
  
  control.ephemeral.add_remaining_word('prior');
  
  control.ephemeral.add_remaining_word('prison');
