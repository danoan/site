...
function create_control() {
  let words_found_cookie_id = '2021-06-22T15:21:07.276473_words_found_thursday';
  let iso_expiration_date = '2022-06-17T15:21:07.276473';
...
window.onload = function () {
  ...
  control.ephemeral.add_remaining_word('metal');
  
  control.ephemeral.add_remaining_word('mutual');
  
  control.ephemeral.add_remaining_word('tall');
  
  control.ephemeral.add_remaining_word('limit');
  
  control.ephemeral.add_remaining_word('mill');
  
  control.ephemeral.add_remaining_word('tell');
  
  control.ephemeral.add_remaining_word('ultimate');
  
  control.ephemeral.add_remaining_word('meal');
  
  control.ephemeral.add_remaining_word('tale');
  
  control.ephemeral.add_remaining_word('time');
  
  control.ephemeral.add_remaining_word('male');
  
  control.ephemeral.add_remaining_word('late');
  
  control.ephemeral.add_remaining_word('meat');
  
  control.ephemeral.add_remaining_word('team');
  
  control.ephemeral.add_remaining_word('mate');
  
  control.ephemeral.add_remaining_word('mall');
  
  control.ephemeral.add_remaining_word('mail');
  
  control.ephemeral.add_remaining_word('item');
  
  control.ephemeral.add_remaining_word('tail');
  
  control.ephemeral.add_remaining_word('title');
  
  control.ephemeral.add_remaining_word('meet');
  
  control.ephemeral.add_remaining_word('militia');
