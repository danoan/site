...
function create_control() {
  let words_found_cookie_id = '2021-06-16T13:36:17.762848_words_found_thursday';
  let iso_expiration_date = '2022-06-11T13:36:17.762848';
...
window.onload = function () {   
  ...
  control.ephemeral.add_remaining_word('immense');
  
  control.ephemeral.add_remaining_word('mine');
  
  control.ephemeral.add_remaining_word('miss');
  
  control.ephemeral.add_remaining_word('less');
  
  control.ephemeral.add_remaining_word('sell');
  
  control.ephemeral.add_remaining_word('mess');
  
  control.ephemeral.add_remaining_word('seem');
  
  control.ephemeral.add_remaining_word('single');
  
  control.ephemeral.add_remaining_word('else');
  
  control.ephemeral.add_remaining_word('smell');
  
  control.ephemeral.add_remaining_word('engine');
  
  control.ephemeral.add_remaining_word('sing');
  
  control.ephemeral.add_remaining_word('mining');
  
  control.ephemeral.add_remaining_word('smile');
  
  control.ephemeral.add_remaining_word('lens');
  
  control.ephemeral.add_remaining_word('mill');
  
  control.ephemeral.add_remaining_word('sign');
  
  control.ephemeral.add_remaining_word('line');
  
  control.ephemeral.add_remaining_word('illness');
  
  control.ephemeral.add_remaining_word('gene');
  
  control.ephemeral.add_remaining_word('nine');
  
  control.ephemeral.add_remaining_word('sense');
  
  control.ephemeral.add_remaining_word('missile');
