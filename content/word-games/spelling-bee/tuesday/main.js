...
function create_control() {
  let words_found_cookie_id = '2021-06-22T15:21:07.101035_words_found_tuesday';
  let iso_expiration_date = '2022-06-17T15:21:07.101035';
...
window.onload = function () {
  ...
  control.ephemeral.add_remaining_word('many');
  
  control.ephemeral.add_remaining_word('noon');
  
  control.ephemeral.add_remaining_word('copy');
  
  control.ephemeral.add_remaining_word('camp');
  
  control.ephemeral.add_remaining_word('company');
  
  control.ephemeral.add_remaining_word('accompany');
