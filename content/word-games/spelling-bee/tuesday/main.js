...
function create_control() {
  let words_found_cookie_id = '2021-06-16T13:36:17.575536_words_found_tuesday';
  let iso_expiration_date = '2022-06-11T13:36:17.575536';
...
window.onload = function () {   
  ...
  control.ephemeral.add_remaining_word('straight');
  
  control.ephemeral.add_remaining_word('hair');
  
  control.ephemeral.add_remaining_word('that');
  
  control.ephemeral.add_remaining_word('trait');
  
  control.ephemeral.add_remaining_word('start');
  
  control.ephemeral.add_remaining_word('high');
  
  control.ephemeral.add_remaining_word('tight');
  
  control.ephemeral.add_remaining_word('shirt');
  
  control.ephemeral.add_remaining_word('harsh');
  
  control.ephemeral.add_remaining_word('this');
  
  control.ephemeral.add_remaining_word('shit');
  
  control.ephemeral.add_remaining_word('right');
  
  control.ephemeral.add_remaining_word('grass');
  
  control.ephemeral.add_remaining_word('sight');
  
  control.ephemeral.add_remaining_word('stir');
  
  control.ephemeral.add_remaining_word('sigh');
  
  control.ephemeral.add_remaining_word('stair');
  
  control.ephemeral.add_remaining_word('assist');
  
  control.ephemeral.add_remaining_word('artist');
  
  control.ephemeral.add_remaining_word('star');
