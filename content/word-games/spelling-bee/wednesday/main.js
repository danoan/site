...
function create_control() {
  let words_found_cookie_id = '2021-06-16T13:36:17.665978_words_found_wednesday';
  let iso_expiration_date = '2022-06-11T13:36:17.665978';
...
window.onload = function () {   
  ...
  control.ephemeral.add_remaining_word('trigger');
  
  control.ephemeral.add_remaining_word('tent');
  
  control.ephemeral.add_remaining_word('teen');
  
  control.ephemeral.add_remaining_word('entity');
  
  control.ephemeral.add_remaining_word('entry');
  
  control.ephemeral.add_remaining_word('enter');
  
  control.ephemeral.add_remaining_word('retire');
  
  control.ephemeral.add_remaining_word('tiny');
  
  control.ephemeral.add_remaining_word('tree');
  
  control.ephemeral.add_remaining_word('tire');
  
  control.ephemeral.add_remaining_word('integrity');
  ...
  control.ephemeral.add_remaining_word('energy');
  ...
  control.ephemeral.add_remaining_word('entire');
