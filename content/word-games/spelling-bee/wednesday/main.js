...
function create_control() {
  let words_found_cookie_id = '2021-06-22T15:21:07.193086_words_found_wednesday';
  let iso_expiration_date = '2022-06-17T15:21:07.193086';
...
window.onload = function () {
  ...
  control.ephemeral.add_remaining_word('also');
  ...
  control.ephemeral.add_remaining_word('loss');
  
  control.ephemeral.add_remaining_word('asset');
  
  control.ephemeral.add_remaining_word('seat');
  
  control.ephemeral.add_remaining_word('less');
  
  control.ephemeral.add_remaining_word('state');
  
  control.ephemeral.add_remaining_word('steel');
  
  control.ephemeral.add_remaining_word('estate');
  
  control.ephemeral.add_remaining_word('toss');
  
  control.ephemeral.add_remaining_word('east');
  
  control.ephemeral.add_remaining_word('boast');
  
  control.ephemeral.add_remaining_word('test');
  
  control.ephemeral.add_remaining_word('toll');
  
  control.ephemeral.add_remaining_word('settle');
  
  control.ephemeral.add_remaining_word('ease');
  
  control.ephemeral.add_remaining_word('label');
  
  control.ephemeral.add_remaining_word('else');
  
  control.ephemeral.add_remaining_word('bass');
  
  control.ephemeral.add_remaining_word('battle');
  
  control.ephemeral.add_remaining_word('stable');
  
  control.ephemeral.add_remaining_word('able');
  
  control.ephemeral.add_remaining_word('base');
  
  control.ephemeral.add_remaining_word('boss');
  
  control.ephemeral.add_remaining_word('slot');
  
  control.ephemeral.add_remaining_word('beast');
  
  control.ephemeral.add_remaining_word('baseball');
  
  control.ephemeral.add_remaining_word('bottle');
  
  control.ephemeral.add_remaining_word('table');
  
  control.ephemeral.add_remaining_word('sell');
  
  control.ephemeral.add_remaining_word('ball');
  
  control.ephemeral.add_remaining_word('sole');
  
  control.ephemeral.add_remaining_word('boat');
  
  control.ephemeral.add_remaining_word('lots');
  
  control.ephemeral.add_remaining_word('tool');
  
  control.ephemeral.add_remaining_word('blast');
  
  control.ephemeral.add_remaining_word('boost');
  
  control.ephemeral.add_remaining_word('obsess');
  
  control.ephemeral.add_remaining_word('salt');
  
  control.ephemeral.add_remaining_word('lose');
  
  control.ephemeral.add_remaining_word('loose');
  
  control.ephemeral.add_remaining_word('late');
  
  control.ephemeral.add_remaining_word('ballet');
  
  control.ephemeral.add_remaining_word('tell');
  
  control.ephemeral.add_remaining_word('least');
  
  control.ephemeral.add_remaining_word('solo');
  
  control.ephemeral.add_remaining_word('sales');
  
  control.ephemeral.add_remaining_word('taste');
  
  control.ephemeral.add_remaining_word('sale');
  
  control.ephemeral.add_remaining_word('stall');
  
  control.ephemeral.add_remaining_word('seal');
  
  control.ephemeral.add_remaining_word('beat');
  
  control.ephemeral.add_remaining_word('steal');
  
  control.ephemeral.add_remaining_word('bell');
  
  control.ephemeral.add_remaining_word('belt');
  
  control.ephemeral.add_remaining_word('stab');
  
  control.ephemeral.add_remaining_word('lost');
  
  control.ephemeral.add_remaining_word('bless');
  
  control.ephemeral.add_remaining_word('best');
  
  control.ephemeral.add_remaining_word('assess');
  
  control.ephemeral.add_remaining_word('last');
  
  control.ephemeral.add_remaining_word('boot');
  
  control.ephemeral.add_remaining_word('ballot');
